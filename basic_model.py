"""
Pytorch implementation of SegNet-basic (https://arxiv.org/pdf/1511.00561.pdf)
"""
...
class SegNet_basic(nn.Module):
    def __init__(self, input_channels, output_channels):
        ...
        self.decoder_convtr_3 = nn.Sequential(*[
        ...
        self.decoder_convtr_2 = nn.Sequential(*[
        ...
        self.decoder_convtr_1 = nn.Sequential(*[
        ...
        self.decoder_convtr_0 = nn.Sequential(*[
    ...
    def forward(self, input_img):
        ...
        x_00 = F.relu(self.encoder_conv_0(input_img))
        x_0, indices_0 = F.max_pool2d(x_00, kernel_size=2, stride=2, return_indices=True)

        # Encoder Stage - 2
        dim_1 = x_0.size()
        x_10 = F.relu(self.encoder_conv_1(x_0))
        x_1, indices_1 = F.max_pool2d(x_10, kernel_size=2, stride=2, return_indices=True)

        # Encoder Stage - 3
        dim_2 = x_1.size()
        x_20 = F.relu(self.encoder_conv_2(x_1))
        x_2, indices_2 = F.max_pool2d(x_20, kernel_size=2, stride=2, return_indices=True)

        # Encoder Stage - 4
        dim_3 = x_2.size()
        x_30 = F.relu(self.encoder_conv_3(x_2))
        x_3, indices_3 = F.max_pool2d(x_30, kernel_size=2, stride=2, return_indices=True)
        ...
        x_30d = F.relu(self.decoder_convtr_3(x_3d))
        dim_3d = x_30d.size()

        # Decoder Stage - 3
        x_2d = F.max_unpool2d(x_30d, indices_2, kernel_size=2, stride=2, output_size=dim_2)
        x_20d = F.relu(self.decoder_convtr_2(x_2d))
        dim_2d = x_20d.size()

        # Decoder Stage - 2
        x_1d = F.max_unpool2d(x_20d, indices_1, kernel_size=2, stride=2, output_size=dim_1)
        x_10d = F.relu(self.decoder_convtr_1(x_1d))
        dim_1d = x_10d.size()

        # Decoder Stage - 1
        x_0d = F.max_unpool2d(x_10d, indices_0, kernel_size=2, stride=2, output_size=dim_0)
        x_00d = self.decoder_convtr_0(x_0d)
        dim_0d = x_00d.size()
