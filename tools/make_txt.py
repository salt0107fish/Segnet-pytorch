...
def make_train_txt(num):
    global i
    paths = glob.glob("/media/xjh/Elements/cityscapes/leftImg8bit/train/*/*")
...
def make_test_txt(num):
    global i
    paths = glob.glob("/media/xjh/Elements/cityscapes/leftImg8bit/test/*/*")
...
def make_val_txt(num):
    global i
    paths = glob.glob("/media/xjh/Elements/cityscapes/leftImg8bit/val/*/*")
