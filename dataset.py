...
VOC_CLASSES = ('road',  # always index 0
               'sidewalk', 'building', 'wall', 'fence',
...
class PascalVOCDataset(Dataset):
    ...
    def __compute_class_probability(self):
        ...
        for name in self.images:
            #tmp = name[49:-18] + "gtFine_labelTrainIds" + self.mask_extension
            tmp = name.split(' ')
    ...
    def load_mask(self, path=None):
        ...
        # border
        imx_t[imx_t>=len(VOC_CLASSES)] = len(VOC_CLASSES)
